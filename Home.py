...
def launch(username):
    ...
    def openAnalysis(_username):
        Analysis.launch(_username)
    ...
    notelabel = Label(right_frame, text="NOTE: Always Enter date in 'yyyy-mm-dd hh:mm:ss' format !",
                      font=('Times New Roman', 12, "bold"), pady=5)
