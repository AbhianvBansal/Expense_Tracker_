...
def launch(username):
    ...
    OPTIONS = ["Cash", "Card", "Cheque", "UPI"]  # etc

    variable = StringVar(container2)
    variable.set(OPTIONS[0])  # default value
    w = OptionMenu(container2, variable, *OPTIONS)
    w.grid(row=5, column=8, padx=6, pady=10)
    btn_add_expense = Button(container2, text="Add Expense",
                             command=lambda: check_expense(eamount, etype, variable, edate),
